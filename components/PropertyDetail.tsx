...
export const PropertyDetail: React.FC<PropertyDetailProps> = ({ property, transactions, onBack, onUpdateNotes }) => {
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="overflow-y-auto" style={{maxHeight: '300px'}}>
                        ...
                        <table className="min-w-full">
                            ...
                            <div className="flex items-center justify-center h-full"><p className="text-slate-500">No transactions for this property.</p></div>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="flex justify-end items-center mt-4">
                    ...
                    <button
                        ...
                        disabled={notes === (property.notes || '') || isSaving}
                    >
